...
def parse_args():
	...
	parser.add_argument('description', type = api_argument_type, nargs = '?', help = 'The description part of the notification. Defaults to the URL specified using --url, if one is specified. Otherwise the description is mandatory,')
	...
	if args.set_api_key is None:
		...
		if args.event is not None or args.description is not None or args.application is not None or args.url is not None or args.priority != 0 or args.api_key is not None:
